...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === "success" && "border-lime-500/30 bg-lime-500/10 text-lime-400",
      className
    )}
    {...props}
  />
...
export function Toaster() {
  ...
  return (
    <ToastProvider>
      {toasts.map((t) => (
        <Toast key={t.id} variant={t.variant} onOpenChange={(open) => { if (!open) toastStore.remove(t.id); }}>
